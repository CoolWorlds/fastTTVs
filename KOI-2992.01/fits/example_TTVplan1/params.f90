...
! Model Parameters
	...
	! sdim = Number of parameters in the model fit
      	INTEGER, PARAMETER :: sdim = 15
      	INTEGER, PARAMETER :: OOTlen = 8
      	INTEGER, PARAMETER :: taulen = 8
      	INTEGER, PARAMETER :: Vsyslen = 0
      	INTEGER, PARAMETER :: nparamorig = 7

        ! seriesP.dat controls
      	INTEGER, PARAMETER :: nplen = 563
        ...
        ! Control flags
        LOGICAL, PARAMETER :: globalflag = .FALSE.
...
! Parameters for Nested Sampler
	...
	parameter(nest_root='chains/TTVplan1-')
