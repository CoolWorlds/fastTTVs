PROGRAM main
	...
	INTEGER :: i, j
        ...
        open(1,FILE='example_TTVplan/jammi_in.jam',FORM='FORMATTED',STATUS='UNKNOWN')
        DO j=1,sdim
        ...
        !--------------------------------------------------------------------------
        ! Open up jammi_in.txt and read file
        open(2784,FILE='example_TTVplan/blends.dat',FORM='FORMATTED',STATUS='UNKNOWN')
        DO j=1,NQ
          read(2784,*) gam(j)
        END DO
        close(2784)
        ...
        IF( priflag .EQ. 1 ) THEN
          ...
          open(unit=30301,file='example_TTVplan/seriesP.jam')
          DO i = 1,nplen
        ...
        IF( rvflag .EQ. 1 ) THEN
          ...
          open(unit=30302,file='example_TTVplan/seriesR.dat')
          DO i = 1,nrlen
